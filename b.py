...
import pandas as pd
import numpy as np
import seaborn as sns #veri görselleştirmesi için kullanılan bir istatistiksel grafik kütüphanesidir. 
import matplotlib.pyplot as plt #grafik oluşturmak için kullanılan bir çizim kütüphanesidir. 
from matplotlib.colors import ListedColormap #renk haritası oluşturmak için kullanılan sınıflardan biridir.
